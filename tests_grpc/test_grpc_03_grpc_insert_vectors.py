#!/usr/bin/env python3
"""Test: gRPC Insert Vectors | Mode: gRPC | Desc: Insert vectors via gRPC
...
class TestGrpcinsertvectors(TestBase):
    def __init__(self):
        super().__init__("gRPC - gRPC Insert Vectors")
        self.client = None
    def setup(self):
        try:
