#!/usr/bin/env python3
"""Test: gRPC Create Index | Mode: gRPC | Desc: Create vector index via gRPC
...
class TestGrpccreateindex(TestBase):
    def __init__(self):
        super().__init__("gRPC - gRPC Create Index")
        self.client = None
    def setup(self):
        try:
