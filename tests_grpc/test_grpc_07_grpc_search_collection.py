#!/usr/bin/env python3
"""Test: gRPC Search Collection | Mode: gRPC | Desc: Search collection via gRPC
...
class TestGrpcsearchcollection(TestBase):
    def __init__(self):
        super().__init__("gRPC - gRPC Search Collection")
        self.client = None
    def setup(self):
        try:
