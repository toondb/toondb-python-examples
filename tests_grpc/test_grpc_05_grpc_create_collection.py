#!/usr/bin/env python3
"""Test: gRPC Collection | Mode: gRPC | Desc: Create collection via gRPC
...
class TestGrpccreatecollection(TestBase):
    def __init__(self):
        super().__init__("gRPC - gRPC Collection")
        self.client = None
    def setup(self):
        try:
